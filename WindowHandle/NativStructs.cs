...
namespace AWC.WindowHandle
{
    public class NativStructs
    {
        ...
        {
            public Dwm_TNP TNP;
            public AWC.WindowHandle.NativStructs.RECT rcDestination;
            public AWC.WindowHandle.NativStructs.RECT rcSource;
            public Byte opacity;
            public Boolean Visible;
            public Boolean SourceClientAreaOnly;
        }
